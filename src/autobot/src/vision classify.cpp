...
public:
	ObjectClassifier(int argc, char** argv ) : it_(nh_)
	{
        ...
        drive_pub_ = nh_.advertise<autobot::drive_param>("/drive_param", 2);
	...
	void imageCb(const autobot::detected_img& detect_msg)
	{
        ...
        driveParam.velocity = 9.0;
        if(class_name == "Left_60")
        {
            driveParam.angle = -60;
        }
        else if(class_name == "Left_45")
        {
            driveParam.angle = -45;
        }
        else if(class_name == "Left_30")
        {
            driveParam.angle = -30;
        }
        else if(class_name == "Left_15")
        {
            driveParam.angle = -15;
        }
        else if(class_name == "Straight_0")
        {
            driveParam.angle = 0;
        }
        else if(class_name == "Right_15")
        {
            driveParam.angle = 15;
        }
        else if(class_name == "Right_30")
        {
            driveParam.angle = 30;
        }
        else if(class_name == "Right_45")
        {
            driveParam.angle = 45;
        }
        else if(class_name == "Right_60")
        {
            driveParam.angle = 60;
        }
